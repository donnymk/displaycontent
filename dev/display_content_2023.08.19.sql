...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 19 Agu 2023 pada 13.49
-- Versi server: 8.0.31
-- Versi PHP: 8.0.26
...
INSERT INTO `admin_outlet` (`id_outlet`, `username`, `password`, `nama_outlet`, `alamat_outlet`, `kota`, `timestamp`) VALUES
(1, 'outlet1', '$2y$10$s4RdWOodjLtWBhGhh72oIulWyKFH9GeFsy5V1sMZVcZbDIFWEt8aW', 'Outlet 1', 'Jalan Melati', 'Kabupaten Jepara', '2023-08-19 20:47:10');
