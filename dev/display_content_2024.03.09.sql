...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 09 Mar 2024 pada 03.00
-- Versi server: 8.0.31
-- Versi PHP: 8.0.26
...
CREATE TABLE IF NOT EXISTS `admin_outlet` (
  ...
  `nama_outlet` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `alamat_outlet` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kota` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `foto_outlet` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(2, 'melati', '$2y$10$BXq2.aL3kc1PN8KUQxR70OtHlED0yaRWLfBmumVsdlLg5VVaAfULa', 'Melati Store', 'Jalan Apel', 'Kabupaten/Kota di Luar Jawa Tengah', '', '2023-12-09 18:36:10');
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `nama_client` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `content` (
  ...
  `jenis_content` enum('gambar','video','teks') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `superadmin` (
  ...
  `username` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_superadmin` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
